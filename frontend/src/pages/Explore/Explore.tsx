            ...
            {results.map((ext) => (
              ...
              >
                <div className="game-card-new__img">
                  ...
                  <span className="sidebar__item-icon" style={{position:'absolute',right:'10px',bottom:'10px',color:'white',fontSize:'1.1rem',background:'rgba(2,6,23,.85)',padding:'4px 8px',borderRadius:'6px',backdropFilter:'blur(4px)',border:'1px solid rgba(139,92,246,.35)'}}><i className="fa-solid fa-cloud-arrow-down" /></span>
                </div>
